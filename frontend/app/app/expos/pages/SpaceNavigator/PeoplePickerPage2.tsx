...
const PeoplePickerPage2 = (props: any) => {
...
// @ts-ignore
PeoplePickerPage2.navigationOptions = navigationOptions;

export default withNavigation(PeoplePickerPage2);
