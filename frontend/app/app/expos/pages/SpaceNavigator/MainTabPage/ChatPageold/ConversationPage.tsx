    ...
    return (
        <Page>
            <GiftedChat
                ...
                disableComposer={!hasActiveMembers(activeConversation)}
                inverted={true}
                messages={messages}
                isKeyboardInternallyHandled={false}
                user={{ _id: myMembership && myMembership.chat ? myMembership.chat.userId : '' }}
        ...
        headerRight: () => (
            <NavHeaderSafeArea>
                <TouchableOpacity onPress={avatarOnPress}>
                    <NavHeaderImageArea imageUrl={coverImageUrl} name={conversationName} initial={iconInitial} />
                </TouchableOpacity>
            </NavHeaderSafeArea>
        ),
        tabBarVisible: false,
