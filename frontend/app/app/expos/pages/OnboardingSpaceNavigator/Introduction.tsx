...
const Introduction = (props: { navigation: any }) => {
    ...
    const gotoNextIntroduction = async () => {
        ...
        if (space) {
            navigation.navigate(routes.ONBOARDING_SPACE_SECONDINTRO, {[PARAM_SPACE]: space});
        } else {
    ...
    var bgPass = require ('../../assets/images/Tree-01.png');
...
// @ts-ignore
Introduction.path = 'intro'; //override path for better web URLs
