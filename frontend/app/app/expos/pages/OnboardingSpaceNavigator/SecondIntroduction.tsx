...
const SecondIntroduction = (props: { navigation: any }) => {
    ...
    const gotoNextIntroduction = async () => {
        ...
        if (space) {
            navigation.navigate(routes.ONBOARDING_SPACE_THIRDINTRO, {[PARAM_SPACE]: space});
        } else {
    ...
    var bgPass = require ('../../assets/images/Tree-02.png');
...
// @ts-ignore
SecondIntroduction.path = 'secondintro'; //override path for better web URLs

export default withNavigation(SecondIntroduction);
