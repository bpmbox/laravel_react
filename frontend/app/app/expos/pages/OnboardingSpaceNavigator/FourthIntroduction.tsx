...
const FourthIntroduction = (props: { navigation: any }) => {
    ...
    const gotoNextIntroduction = async () => {
        ...
        if (space) {
            navigation.navigate(routes.ONBOARDING_SPACE_FIFTHINTRO, {[PARAM_SPACE]: space});
        } else {
    ...
    var bgPass = require ('../../assets/images/Tree-04.png');
...
// @ts-ignore
FourthIntroduction.path = 'fourthintro'; //override path for better web URLs

export default withNavigation(FourthIntroduction);
