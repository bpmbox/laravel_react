...
const SixthIntroduction = (props: { navigation: any }) => {
    ...
    const gotoNextIntroduction = async () => {
        ...
        if (space) {
            navigation.navigate(routes.ONBOARDING_SPACE_SEVENTHINTRO, {[PARAM_SPACE]: space});
        } else {
    ...
    var bgPass = require ('../../assets/images/Tree-06.png');
...
// @ts-ignore
SixthIntroduction.path = 'sixthintro'; //override path for better web URLs

export default withNavigation(SixthIntroduction);
