...
const ThirdIntroduction = (props: { navigation: any }) => {
    ...
    const gotoNextIntroduction = async () => {
        ...
        if (space) {
            navigation.navigate(routes.ONBOARDING_SPACE_FOURTHINTRO, {[PARAM_SPACE]: space});
        } else {
    ...
    var bgPass = require ('../../assets/images/Tree-03.png');
...
// @ts-ignore
ThirdIntroduction.path = 'thirdintro'; //override path for better web URLs

export default withNavigation(ThirdIntroduction);
