...
import openUrl from 'react-native-markdown-display/src/lib/util/openUrl';
import hasParents from 'react-native-markdown-display/src/lib/util/hasParents';


const _MARKDOWN_ALL_RULES = [
    // Rules block
    'table',
    'code',
    'fence',
...
export const MARKDOWN_ENABLED_RULES =[
   // Rules block
   //  'table',
    'code',
    'fence',
...
export const MARKDOWN_DISABLED_RULES = difference(_MARKDOWN_ALL_RULES, MARKDOWN_ENABLED_RULES);

const genMarkdownRenderRules = (textSelectable: boolean) => {
    const codeBlockAndFence = (
        ...
        return (
            <Text key={node.key} selectable={textSelectable} style={[inheritedStyles, styles.codeBlock]}>
                {content}
            </Text>
        );
    };
    ...
    const renderRules = {
        ...
        text: (node, children, parent, styles, inheritedStyles = {}) => (
            <Text key={node.key} selectable={textSelectable} style={[inheritedStyles, styles.text]}>
                {node.content}
            </Text>
        ),
        textgroup: (node, children, parent, styles) => (
            <Text key={node.key} selectable={textSelectable} style={styles.textGroup}>
                {children}
            </Text>
        ),
        strong: (node, children, parent, styles) => (
            <Text key={node.key} selectable={textSelectable} style={styles.strong}>
                {children}
            </Text>
        ),
        s: (node, children, parent, styles) => (
            <Text key={node.key} selectable={textSelectable} style={styles.strikethrough}>
                {children}
            </Text>
        ),
        ...
        em: (node, children, parent, styles) => (
            <Text key={node.key} selectable={textSelectable} style={styles.em}>
                {children}
            </Text>
        ),
        ...
        hardbreak: (node, children, parent, styles) => (
            <Text key={node.key} selectable={textSelectable} style={styles.hardbreak}>
                {'\n'}
            </Text>
        ),
        ...
        code_inline: (node, children, parent, styles, inheritedStyles = {}) => (
            <Text key={node.key} selectable={textSelectable} style={[inheritedStyles, styles.codeInline]}>
                {node.content}
            </Text>
        ),
...
export const textSelectableRules = genMarkdownRenderRules(true);
export const textNonSelectableRules = genMarkdownRenderRules(false);
